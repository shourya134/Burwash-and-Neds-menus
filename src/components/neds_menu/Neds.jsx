        ...
        <div className='App'>
            ...
            <header className='forheader'>
                ...
                <p className='food_details'>
                    ...
                    For x years, Ned's has been a welcoming space for students to connect and enjoy a diverse menu accomponied with Pastries, Hot & ColdBeverages, Yogurt, Milk, Whole Fruits, Snacks and Desserts all day every weekday.
